...
import (
	...
	goonvif "github.com/neverhover/onvif"
	"github.com/neverhover/onvif/device"
	"github.com/neverhover/onvif/gosoap"
	"github.com/neverhover/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		/*
			You could use https://github.com/neverhover/onvif/gosoap for pretty printing response
		*/
